...
public class Usuarios implements Initializable {
    ...
    public void show() throws IOException {
        ...
        root.setControllerFactory(c -> new Usuarios());
    ...
    public void botaoEditUsuario() throws IOException {
    ...
    public void botaoViewUsuario() throws IOException {
    ...
    public void verificaSelecao(){
        if (!tbView.getSelectionModel().isEmpty()){
            ...
            btRemove.setDisable(Login.getUser().getCargo() == 1);
