...
public class VisualizarCompra implements Initializable{
    ...
    public void show(Compra compra, boolean view) throws IOException {
        ...
        root.setControllerFactory(c -> new VisualizarCompra(compra, view));
    ...
    public void fillFields(){
        ...
        txTotal.setText(NumberFormat.getCurrencyInstance().format(compra.getValor()));
