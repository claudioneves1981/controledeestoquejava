...
public class NovaCompra implements Initializable {
    ...
    public void show() throws IOException {
        ...
        root.setControllerFactory(c -> new NovaCompra());
    ...
    public void show(boolean view, Compra compra) throws IOException {
        Stage primaryStage = new Stage();
        FXMLLoader root = new FXMLLoader(getClass().getResource("/views/NovaCompra.fxml"));
        root.setControllerFactory(c -> new NovaCompra(view, compra));
    ...
    public void visualizarCompra()  {
        ...
        txPrecoTotal.clear();
        txPrecoTotal.setText(NumberFormat.getCurrencyInstance().format(compra.getValor()));
        txVendedor.clear();
    ...
    public void fillFields(){
        ...
        txPrecoCompra.setText(NumberFormat.getCurrencyInstance().format(p.getPreco()));
    }
    ...
    if(!view) {
        btAdicionar.setDisable(txNome.getText().isEmpty() || txPrecoCompra.getText().isEmpty() || txPrecoUn.getText().isEmpty() ||
                txQtdEstoque.getText().isEmpty() || txQtdCompra.getText().isEmpty() || txId.getText().isEmpty());
        btFinalizar.setDisable(produtos.isEmpty() || dtEntrega.getValue() == null);
        btRemover.setDisable(produtos.isEmpty());
    }///
