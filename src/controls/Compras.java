...
public class Compras implements Initializable {
    ...
    public void show() throws IOException {
        ...
        root.setControllerFactory(c -> new Compras());
    ...
    public void verificaSelecao(){
        btVisualizar.setDisable(tbCPendentes.getSelectionModel().isEmpty());

        btVisualizar.setDisable(!tbCPendentes.isFocused());
    }

    public void verificaData(){
        Date data = new Date(System.currentTimeMillis());
        tbCPendentes.setRowFactory(tv -> new TableRow<Compra>() {
            @Override
