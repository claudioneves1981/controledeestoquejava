...
public class FornecedorDAO {
    ...
    public void add(Fornecedor f) throws ClassNotFoundException {
        ...
        try {
            ...
            stmt = con.con.prepareStatement("INSERT INTO fornecedor(nome, cnpj, tel1, tel2, cep, num, rua, comp, bairro, cidade, estado)" +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
    ...
    public void up(Fornecedor f) throws ClassNotFoundException {
        ...
        try {
            ...
            stmt = con.con.prepareStatement("UPDATE fornecedor SET nome = ?, cnpj = ?, tel1 = ?, tel2 = ?, " +
    ...
    public List<Fornecedor> listAll() throws ClassNotFoundException {
        ...
        try {
            stmt = con.con.prepareStatement("SELECT * FROM fornecedor WHERE deleted_at is NULL;");
    ...
    public List<Fornecedor> listAllById(String id) {
        con.getConnection();
        //Connection con = ConnectionFactory.getConnection();
        PreparedStatement stmt = null;
        ResultSet rs = null;
        ...
        try {
            stmt = con.con.prepareStatement("SELECT * FROM fornecedor WHERE id LIKE ? AND deleted_at is NULL;");
            stmt.setString(1, "%" + id + "%");
            rs = stmt.executeQuery();
    ...
    public List<Fornecedor> listAllByName(String nome) throws ClassNotFoundException {
        ...
        try {
            stmt = con.con.prepareStatement("SELECT * FROM fornecedor WHERE nome LIKE ? AND deleted_at is NULL;");
    ...
    public void del(Fornecedor f){   // ou pelo id, public void del(int id)
        ...
        try {
            ...
            stmt = con.con.prepareStatement("UPDATE fornecedor SET deleted_at = ? WHERE id = ?;");
    ...
    public Fornecedor read(int id) throws ClassNotFoundException {
        ...
        try {
            stmt = con.con.prepareStatement("SELECT id, nome, cnpj, tel1, tel2, cep, " +
    ...
    public int idAutoIncrement() {
        ...
        try {
            stmt = con.con.prepareStatement("SELECT AUTO_INCREMENT FROM information_schema.tables WHERE table_name = 'fornecedor' AND table_schema = 'controlx'");
            rs = stmt.executeQuery();
