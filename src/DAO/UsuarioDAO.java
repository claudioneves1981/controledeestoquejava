...
public class UsuarioDAO {
    ...
    public boolean checkLogin(String login, String senha){
        ...
        try {
            stmt = con.con.prepareStatement("SELECT * FROM usuario WHERE login = ? and senha = ? and deleted_at is NULL;");
    ...
    public void add(Usuario u) throws ClassNotFoundException {
        ...
        try {
            ...
            stmt = con.con.prepareStatement("INSERT INTO usuario (nome, cpf, sexo, dataNasc," +
    ...
    public void up(Usuario u) throws ClassNotFoundException {
        ...
        try {
            stmt = con.con.prepareStatement("UPDATE usuario SET nome = ?, cpf = ?, sexo = ?, dataNasc = ?," +
    ...
    public List<Usuario> listAll() throws ClassNotFoundException {
        ...
        try {
            stmt = con.con.prepareStatement("SELECT * FROM usuario WHERE deleted_at is NULL;");
            rs = stmt.executeQuery();
    ...
    public List<Usuario> listAllById(String id) {
        con.getConnection();
       // Connection con = ConnectionFactory.getConnection();
        PreparedStatement stmt = null;
        ResultSet rs = null;
        ...
        try {
            stmt = con.con.prepareStatement("SELECT * FROM usuario WHERE id LIKE ? AND deleted_at is NULL;");
            stmt.setString(1, "%" + id + "%");
            rs = stmt.executeQuery();
    ...
    public List<Usuario> listAllByName(String nome) throws ClassNotFoundException {
        ...
        try {
            stmt = con.con.prepareStatement("SELECT * FROM usuario WHERE nome LIKE ? AND deleted_at is NULL;");
    ...
    public void del(Usuario u) {   // ou pelo id, public void del(int id)
        ...
        try {
            ...
            stmt = con.con.prepareStatement("UPDATE usuario SET deleted_at = ? WHERE id = ?;");
    ...
    public Usuario read(int id) throws ClassNotFoundException {
        ...
        try {
            stmt = con.con.prepareStatement("SELECT * "+
    ...
    public int idAutoIncrement() throws ClassNotFoundException {
        ...
        try {
            stmt = con.con.prepareStatement("SELECT AUTO_INCREMENT FROM information_schema.tables WHERE table_name = 'usuario' AND table_schema = 'controlx'");
            rs = stmt.executeQuery();
    ...
    public boolean verificaLogin(String login)  {
        ...
        try {
            stmt = con.con.prepareStatement("SELECT * FROM usuario WHERE login = ?;");
            stmt.setString(1, login);
            rs = stmt.executeQuery();
